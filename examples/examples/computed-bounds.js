...
const box1 = new Mesh(new BoxGeometry(1, 3, 1), new MeshNormalMaterial());
...
const controls1Label = new _default("default separation", 0.3);
const controls2Label = new _default("useComputedBounds=true, default separation", 0.3);
