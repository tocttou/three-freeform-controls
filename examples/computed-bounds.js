...
const box1 = new THREE.Mesh(new THREE.BoxGeometry(1, 3, 1), new THREE.MeshNormalMaterial());
...
const controls1Label = new SpriteText("default separation", 0.3);
const controls2Label = new SpriteText("useComputedBounds=true, default separation", 0.3);
